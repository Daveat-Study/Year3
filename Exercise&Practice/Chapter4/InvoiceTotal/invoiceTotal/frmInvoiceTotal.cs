        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            ****************************************/
            ...
            if (txtEnterSubTotal.Text != "")
            {
                ...
                numOfInvoice++;
                txtNumberOfInvoices.Text = numOfInvoice.ToString();

                // Calculate Total Invoice
                totalOfInvoice += invoiceTotal;
                txtTotalOfInvoice.Text = totalOfInvoice.ToString("c2");

                // Calculate Total Average
                txtInvoiceAverage.Text = (totalOfInvoice / numOfInvoice).ToString("c2");
            }
        }
